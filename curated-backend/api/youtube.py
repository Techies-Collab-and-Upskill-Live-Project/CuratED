...
def fetch_videos_by_keyword(query, max_results=10, educational_focus=True, content_filter='moderate'):
    ...
    params = {
        ...
        'videoDuration': 'medium',   # short: <4m, medium: 4-20m, long: >20m
    }
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if not video_ids:
                ...
                # Return the original data for debugging
                return {
                    "results": [], 
            ...
            # If we filtered out all results, return original search items as fallback
...
def process_search_results(search_data, detailed_results, original_query):
    ...
    # Get detailed video data into a dictionary for easier access
    video_details = {}
    ...
    for item in search_data['items']:
        try:
            ...
            # Skip videos that are clearly not educational (can be expanded)
            ...
            if video_id in video_details:
                ...
                if 'statistics' in details:
                    ...
                    # Videos with engagement tend to be more helpful
                    if likes > 1000:
                        relevance_score += 1
    ...
    # Sort by educational relevance score
